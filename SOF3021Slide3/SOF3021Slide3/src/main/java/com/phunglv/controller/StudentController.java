...
import com.phunglv.bean.Major;
import com.phunglv.bean.Student1;
import com.phunglv.bean.Student2;
...
public String validate1(ModelMap model, 
    ...
    public String validate2(@RequestBody @Valid @ModelAttribute("student") Student2 student,  BindingResult errors, ModelMap model) {
    ...
    public List<Major> getMajors() {
            ...
            majors.add(new Major("MOB", "Lập trình mobile"));
            return majors;
    }
}