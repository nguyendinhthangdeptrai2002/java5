...
public class ProductController {
	...
	@RequestMapping("/product/list-id-1005")
	...
	public String list(Model model, @RequestParam("idd")String id) {		
...
//		List<Product> items = dao.findByPrice(min, max);
	...
	@RequestMapping("/product/list-price")
	public String listPrice(Model model) {		
//		List<Product> list1 = dao.findByPrice1(20);	
//		model.addAttribute("items", list1);	
//		return "product/sort";
//		
		List<Product> list2 = dao.findByPrice2(30, Sort.by(Direction.DESC,"price"));	
